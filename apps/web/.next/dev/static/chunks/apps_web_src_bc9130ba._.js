...
"[project]/apps/web/src/components/SyncTranscriptDetailButton.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SyncTranscriptDetailButton() {
    ...
    async function onSync() {
        setLoading(true);
        setTone("info");
        setMsg(t("transcriptDetail.sync.scanning", "Đang quét bảng điểm chi tiết từ MYDTU. Quá trình này có thể mất vài phút nếu có nhiều học kỳ và lớp học phần."));
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$extensionBridge$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["requestTranscriptDetailSync"])();
            if (!res.ok) {
                setTone("error");
                setMsg(res.error || t("transcriptDetail.sync.failed", "Đồng bộ bảng điểm chi tiết thất bại."));
                return;
            }
            ...
            if (!upstream.ok) {
                setTone("error");
                setMsg(json?.message || json?.error || t("transcriptDetail.sync.saveFailed", "Lưu bảng điểm chi tiết thất bại."));
                return;
            }
            const inserted = Number(json?.counts?.inserted || 0);
            const totalItems = Number(res.payload?.meta?.totalItems || 0);
            const totalClasses = Number(res.payload?.meta?.totalClasses || 0);
            const totalSemesters = Number(res.payload?.meta?.totalSemesters || 0);
            setTone(inserted > 0 ? "success" : "error");
            setMsg(inserted > 0 ? t("transcriptDetail.sync.successRows", "Đồng bộ thành công {{inserted}} dòng thành phần từ {{totalClasses}} lớp thuộc {{totalSemesters}} học kỳ.", {
                inserted,
                totalClasses,
                totalSemesters
            }) : t("transcriptDetail.sync.noInserted", "Đã quét được {{totalItems}} dòng nhưng chưa lưu được dòng nào vào dữ liệu hiển thị. Kiểm tra lại ghép transcript ở backend.", {
                totalItems
            }));
...
_s(SyncTranscriptDetailButton, "bXZoN7LjNZqOHTxaNWoMzXI7g34=", false, function() {
    return [
...
_c = SyncTranscriptDetailButton;
var _c;
__turbopack_context__.k.register(_c, "SyncTranscriptDetailButton");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/apps/web/src/lib/transcript/detail.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/src/app/(app)/transcript/TranscriptDetailExtensionConnect.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$19$2e$2$2e$4_react$40$19$2e$2$2e$4_$5f$react$40$19$2e$2$2e$4$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/next@16.1.6_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$components$2f$SyncTranscriptDetailButton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/components/SyncTranscriptDetailButton.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$transcript$2f$detail$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/transcript/detail.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$19$2e$2$2e$4_react$40$19$2e$2$2e$4_$5f$react$40$19$2e$2$2e$4$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/next@16.1.6_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$react$2d$i18next$40$15$2e$7$2e$4_i18nex_2cb1b8d79cc72435b3673ef4f52e90d5$2f$node_modules$2f$react$2d$i18next$2f$dist$2f$es$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/react-i18next@15.7.4_i18nex_2cb1b8d79cc72435b3673ef4f52e90d5/node_modules/react-i18next/dist/es/index.js [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$react$2d$i18next$40$15$2e$7$2e$4_i18nex_2cb1b8d79cc72435b3673ef4f52e90d5$2f$node_modules$2f$react$2d$i18next$2f$dist$2f$es$2f$useTranslation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/react-i18next@15.7.4_i18nex_2cb1b8d79cc72435b3673ef4f52e90d5/node_modules/react-i18next/dist/es/useTranslation.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$app$2f28$app$292f$transcript$2f$TranscriptDetailExtensionConnect$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/app/(app)/transcript/TranscriptDetailExtensionConnect.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
...
function TranscriptDetailPage() {
    ...
    async function load() {
        ...
        setError(null);
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$transcript$2f$detail$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchTranscriptDetail"])();
            setItems(data.items || []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$19$2e$2$2e$4_react$40$19$2e$2$2e$4_$5f$react$40$19$2e$2$2e$4$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TranscriptDetailPage.useEffect": ()=>{
            void load();
        }
    }["TranscriptDetailPage.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$19$2e$2$2e$4_react$40$19$2e$2$2e$4_$5f$react$40$19$2e$2$2e$4$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TranscriptDetailPage.useEffect": ()=>{
            const onUpdated = {
                "TranscriptDetailPage.useEffect.onUpdated": ()=>{
                    void load();
                }
            }["TranscriptDetailPage.useEffect.onUpdated"];
    ...
    const semesterOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$19$2e$2$2e$4_react$40$19$2e$2$2e$4_$5f$react$40$19$2e$2$2e$4$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TranscriptDetailPage.useMemo[semesterOptions]": ()=>{
            return Array.from(new Set(items.map({
                "TranscriptDetailPage.useMemo[semesterOptions]": (x)=>x.semester
            }["TranscriptDetailPage.useMemo[semesterOptions]"]))).sort(compareSemesters);
        }
    }["TranscriptDetailPage.useMemo[semesterOptions]"], [
        items
    ]);
    const classCodeOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$19$2e$2$2e$4_react$40$19$2e$2$2e$4_$5f$react$40$19$2e$2$2e$4$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TranscriptDetailPage.useMemo[classCodeOptions]": ()=>{
            return Array.from(new Set(items.map({
                "TranscriptDetailPage.useMemo[classCodeOptions]": (x)=>x.classCode
            }["TranscriptDetailPage.useMemo[classCodeOptions]"]))).sort();
        }
    }["TranscriptDetailPage.useMemo[classCodeOptions]"], [
        items
    ]);
    const filteredItems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$19$2e$2$2e$4_react$40$19$2e$2$2e$4_$5f$react$40$19$2e$2$2e$4$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TranscriptDetailPage.useMemo[filteredItems]": ()=>{
            return items.filter({
                "TranscriptDetailPage.useMemo[filteredItems]": (item)=>{
                    const source = [
                        item.semester,
                        item.courseCode,
                        item.classCode,
    ...
    const grouped = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$19$2e$2$2e$4_react$40$19$2e$2$2e$4_$5f$react$40$19$2e$2$2e$4$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TranscriptDetailPage.useMemo[grouped]": ()=>{
            ...
            return Array.from(semesterMap.entries()).sort({
                "TranscriptDetailPage.useMemo[grouped]": (a, b)=>compareSemesters(a[0], b[0])
            }["TranscriptDetailPage.useMemo[grouped]"]).map({
                "TranscriptDetailPage.useMemo[grouped]": ([semester, classMap])=>({
                        semester,
                        classes: Array.from(classMap.entries()).map({
                            "TranscriptDetailPage.useMemo[grouped]": ([classKey, rows])=>({
                                    classKey,
                                    ...
                                    rows: [
                                        ...
                                        "TranscriptDetailPage.useMemo[grouped]": (a, b)=>a.displayOrder - b.displayOrder
                                    }["TranscriptDetailPage.useMemo[grouped]"])
                                })
                        }["TranscriptDetailPage.useMemo[grouped]"]).sort({
                            "TranscriptDetailPage.useMemo[grouped]": (a, b)=>{
    ...
    const totalClasses = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$19$2e$2$2e$4_react$40$19$2e$2$2e$4_$5f$react$40$19$2e$2$2e$4$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TranscriptDetailPage.useMemo[totalClasses]": ()=>new Set(filteredItems.map({
                "TranscriptDetailPage.useMemo[totalClasses]": (item)=>`${item.semester}||${item.classCode}`
            }["TranscriptDetailPage.useMemo[totalClasses]"])).size
    }["TranscriptDetailPage.useMemo[totalClasses]"], [
        filteredItems
    ]);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$19$2e$2$2e$4_react$40$19$2e$2$2e$4_$5f$react$40$19$2e$2$2e$4$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$19$2e$2$2e$4_react$40$19$2e$2$2e$4_$5f$react$40$19$2e$2$2e$4$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$19$2e$2$2e$4_react$40$19$2e$2$2e$4_$5f$react$40$19$2e$2$2e$4$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$19$2e$2$2e$4_react$40$19$2e$2$2e$4_$5f$react$40$19$2e$2$2e$4$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$components$2f$SyncTranscriptDetailButton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                                fileName: "[project]/apps/web/src/app/(app)/transcript/detail/page.tsx",
                                lineNumber: 253,
                                columnNumber: 11
                            }, this),
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$19$2e$2$2e$4_react$40$19$2e$2$2e$4_$5f$react$40$19$2e$2$2e$4$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$app$2f28$app$292f$transcript$2f$TranscriptDetailExtensionConnect$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                fileName: "[project]/apps/web/src/app/(app)/transcript/detail/page.tsx",
                lineNumber: 276,
                columnNumber: 7
            }, this),
...
_s(TranscriptDetailPage, "C1HLWHuIYlnyB/WVVSBKBbDKCpU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$react$2d$i18next$40$15$2e$7$2e$4_i18nex_2cb1b8d79cc72435b3673ef4f52e90d5$2f$node_modules$2f$react$2d$i18next$2f$dist$2f$es$2f$useTranslation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTranslation"]
    ];
});
_c2 = TranscriptDetailPage;
var _c, _c1, _c2;
__turbopack_context__.k.register(_c, "StatCard");
__turbopack_context__.k.register(_c1, "EmptyBox");
__turbopack_context__.k.register(_c2, "TranscriptDetailPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=apps_web_src_bc9130ba._.js.map