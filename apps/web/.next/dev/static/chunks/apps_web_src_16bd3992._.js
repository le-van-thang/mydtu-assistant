...
(()=>{
    const e = new Error("Cannot find module '@/lib/exams/notify'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
    ...
    const filtered = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$19$2e$2$2e$4_react$40$19$2e$2$2e$4_$5f$react$40$19$2e$2$2e$4$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ExamsPage.useMemo[filtered]": ()=>{
            ...
            if (sortMode === "date-asc") mapped.sort(compareDateTimeAsc);
                ...
                mapped.sort({
                    "ExamsPage.useMemo[filtered]": (a, b)=>`${a.courseCode} ${a.courseName || ""}`.localeCompare(`${b.courseCode} ${b.courseName || ""}`, "vi")
                }["ExamsPage.useMemo[filtered]"]);
            } else if (sortMode === "student-asc") {
                mapped.sort({
                    "ExamsPage.useMemo[filtered]": (a, b)=>`${a.studentName || ""} ${a.studentId || ""}`.localeCompare(`${b.studentName || ""} ${b.studentId || ""}`, "vi")
                }["ExamsPage.useMemo[filtered]"]);
            }
            return mapped;
        }
        ...
        try {
            ...
            if (newRecordsForNotify.length) {
                ...
                if (permission === "granted") {
                    notifyNewExams(newRecordsForNotify);
                }
            }
        } catch (e) {
...
_s(ExamsPage, "ZfafBU375Xf6Ly4ztN5GcsOsrKI=", false, function() {
    return [
...
//# sourceMappingURL=apps_web_src_16bd3992._.js.map