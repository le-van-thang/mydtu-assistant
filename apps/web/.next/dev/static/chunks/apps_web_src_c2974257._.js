...
function ExamsPage() {
    ...
    const filtered = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$19$2e$2$2e$4_react$40$19$2e$2$2e$4_$5f$react$40$19$2e$2$2e$4$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ExamsPage.useMemo[filtered]": ()=>{
            ...
            if (planFilter !== "all") {
                next = next.filter({
                    "ExamsPage.useMemo[filtered]": (r)=>r.planType === planFilter
                }["ExamsPage.useMemo[filtered]"]);
            }
            if (tokens.length) {
                next = next.filter({
                    "ExamsPage.useMemo[filtered]": (r)=>{
                        const loose = [
                            r.courseCode,
                            r.courseName,
                            r.studentId,
                        ...
                        return tokens.some({
                            "ExamsPage.useMemo[filtered]": (t)=>loose.some({
                                    "ExamsPage.useMemo[filtered]": (v)=>v.includes(t.loose)
                                }["ExamsPage.useMemo[filtered]"]) || compact.some({
                                    "ExamsPage.useMemo[filtered]": (v)=>v.includes(t.compact)
                                }["ExamsPage.useMemo[filtered]"])
                        }["ExamsPage.useMemo[filtered]"]);
                    }
                }["ExamsPage.useMemo[filtered]"]);
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$19$2e$2$2e$4_react$40$19$2e$2$2e$4_$5f$react$40$19$2e$2$2e$4$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ExamsPage.useMemo[stats]": ()=>{
            ...
            return {
                ...
                official,
                tentative,
                courses: new Set(records.map({
                    "ExamsPage.useMemo[stats]": (r)=>r.courseCode
                }["ExamsPage.useMemo[stats]"])).size
            };
        }
    }["ExamsPage.useMemo[stats]"], [
        records
    ...
    async function handleSync() {
        ...
        setError(null);
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$extensionBridge$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["requestExamSync"])({
                maxPages: 3,
                maxItems: 40
            });
            if (!res.ok) {
            ...
            await Promise.all(res.payload.notices.map(async (notice)=>{
                const rows = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$exams$2f$parseWorkbook$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseWorkbookFromNotice"])(notice);
                parsed.push(...rows);
            }));
...
_s(ExamsPage, "t2nkkqaotaqAdVgA2kwWKFMz2s4=", false, function() {
    return [
...
//# sourceMappingURL=apps_web_src_c2974257._.js.map