...
"[project]/apps/web/src/app/api/sync/transcript-detail/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
function getTokenFromCookieStore(cookieStore) {
...
async function POST(req) {
    ...
    if (!token) {
        return new Response(JSON.stringify({
            ok: false,
            message: "Unauthorized: missing auth cookie. Hãy đăng nhập ứng dụng MYDTU Assistant trước."
        }), {
            status: 401,
            headers: {
                "content-type": "application/json"
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f0ef9127._.js.map