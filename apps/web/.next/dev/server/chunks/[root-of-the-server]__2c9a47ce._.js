...
"[project]/apps/web/src/app/api/import/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    if (!baseUrl) {
        return new Response("Missing API_BASE_URL", {
            status: 500
        });
    }
    ...
    if (!token) {
        return new Response("Unauthorized: missing token cookie", {
            status: 401
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2c9a47ce._.js.map