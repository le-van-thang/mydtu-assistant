...
function SyncTimetableButton() {
    ...
    async function onSync() {
        ...
        try {
            ...
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$extensionBridge$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["requestSyncFromExtension"])("timetable");
            if (!res.ok) {
                setMsg(res.error);
                return;
            }
...
//# sourceMappingURL=apps_web_src_687fc903._.js.map