...
async function requestTranscriptSync() {
    try {
        const res = await sendToExtension("MYDTU_SYNC_TRANSCRIPT", null, DEFAULT_TIMEOUT_MS, "Extension background did not respond in time.");
        if (!res.ok) {
            return {
                ok: false,
...
// path: apps/web/src/components/SyncTranscriptButton.tsx
"use client";
;
;
;
function SyncTranscriptButton() {
    ...
    async function onSync() {
        setLoading(true);
        setMsg("Đang quét bảng điểm từ MYDTU...");
        setTone("info");
        try {
            ...
            if (!res.ok) {
                setTone("error");
                setMsg(res.error || "Đồng bộ bảng điểm thất bại.");
                return;
            }
            ...
            if (!upstream.ok) {
                setTone("error");
                setMsg(json?.message || json?.error || "Lưu bảng điểm thất bại.");
                return;
            }
            const totalItems = Number(res.payload?.meta?.totalItems || 0);
            setTone("success");
            setMsg(`Đã đồng bộ thành công ${totalItems} dòng bảng điểm.`);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$19$2e$2$2e$4_react$40$19$2e$2$2e$4_$5f$react$40$19$2e$2$2e$4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$19$2e$2$2e$4_react$40$19$2e$2$2e$4_$5f$react$40$19$2e$2$2e$4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                ...
                children: loading ? "Đang đồng bộ..." : "Sync bảng điểm"
            }, void 0, false, {
...
function TranscriptPage() {
    ...
    async function load() {
        ...
        setError(null);
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$transcript$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchTranscript"])(semesterFilter === "all" ? undefined : semesterFilter);
            setItems(data.items || []);
...
//# sourceMappingURL=apps_web_src_ecf7287b._.js.map